...
@implementation UIView (sn_Extension)

+ (void)addAnimationRotation:(UIView *)view {
    CAKeyframeAnimation * keyAnima = [CAKeyframeAnimation animation];
    keyAnima.keyPath = @"transform.rotation";
    keyAnima.duration = 0.28;
...
+ (void)addAnimationScale:(UIView *)view {
    CAKeyframeAnimation * keyAnima = [CAKeyframeAnimation animationWithKeyPath:@"transform.scale"];
    keyAnima.duration = 1.f;
    keyAnima.values = @[@1,@1.4f,@1];
    keyAnima.repeatCount = CGFLOAT_MAX;
    keyAnima.fillMode = kCAFillModeForwards;
    keyAnima.removedOnCompletion = NO;
    [view.layer addAnimation:keyAnima forKey:nil];
